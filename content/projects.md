...
- Developed an LLMOps based web application using React and Next.js.
- Integrated OpenAI, DeepSeek, Google Gemini & Anthropic Claude API for natural language.
- Implemented a custom code editor with syntax highlighting.

## [GeminiWire](https://anas1412.github.io/GeminiWire/)

AI-Driven Workflow Automation

- Created GeminiWire for custom AI-powered workflows with real-time execution.
...
## [Laravel Deployment](https://anas1412.github.io/ELK-Stack-with-Laravel/)
